...
export function TreinoCalen({nome, descricao, partesAfeto, open, foto,setOpentreino, id, setTreinoid, setOpenEnv,  setOpenEdit }) {
    ...
    return (
        <div className="w-80 aspect-[10/10] glassBg border-2 border-zinc-500 flex-col font-Sora-light justify-center flex items-center p-4 rounded-[16px]">
            <div className="h-1/2 aspect-square rounded-2xl" style={{ backgroundImage: `url(${foto})`, backgroundSize: 'cover' }}></div>
            <div className='h-2/3 w-full  flex flex-col  justify-center text-offWhite-100 items-center'>
