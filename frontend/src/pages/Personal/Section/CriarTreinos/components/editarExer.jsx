...
export function EditaExer({ open, setOpenExer, id, setExercicios }) {
    ...
    return (
        ...
        >
            ...
            <svg onClick={() => setOpenExer(0)} className='cursor-pointer hover:text-red-500 duration-500 absolute top-4 right-4' width="36" height="36" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M36 12L12 36M12 12L36 36" stroke="currentColor" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </form>
    );
}
