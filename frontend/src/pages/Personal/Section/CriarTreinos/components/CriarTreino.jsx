...
export function CriarTreino({ open, setOpenCria, id, setTreinos }) {
    ...
    return (
        <div className={`w-full fixed inset-0 h-full backdrop-blur-xs flex justify-center items-center py-12 duration-500 transition-all ${open ? 'popModal' : 'dropModal invisible'}`} onClick={() => setOpenCria(0)}>
